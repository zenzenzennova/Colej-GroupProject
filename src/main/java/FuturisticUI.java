...
final class FuturisticUI {
    ...
    static BannerPanel banner(String resourcePath, int height) {
        BannerPanel panel = new BannerPanel(resourcePath);
    ...
    static JLabel title(JLabel label, String text, int size) {
        label.setText(text);
        label.setFont(new Font(FONT_FAMILY, Font.BOLD, size));
    ...
    static JLabel body(JLabel label, String text, int size) {
        label.setText(text);
        label.setFont(new Font(FONT_FAMILY, Font.PLAIN, size));
    ...
    static void styleTextField(JTextField field, Color textColor, Color accentColor, Color borderColor) {
        field.setFont(new Font(FONT_FAMILY, Font.BOLD, 18));
        field.setForeground(textColor);
        field.setCaretColor(accentColor);
        field.setSelectedTextColor(WHITE);
        field.setSelectionColor(accentColor);
        field.setOpaque(false);
        field.setBorder(new RoundedBorder(borderColor, new Insets(12, 16, 12, 16), 16));
    }
    ...
    private static Image loadImage(String resourcePath) {
        URL url = FuturisticUI.class.getResource(resourcePath);
        if (url != null) {
    ...
    static final class BannerPanel extends JPanel {
        ...
        BannerPanel(String resourcePath) {
